package com.example.enhanceittechincaltest.utils.core

import android.content.Context
import android.content.SharedPreferences

object SharedPrefHelper {
    const val PREF_KEY_DEVICE="device_data"
    ...
    operator fun set(key: String, value: Any?) =
        when (value) {
            ...
            is Set<*> -> preferences.edit {
                try{
                    var inputObj :Set<String> = value as Set<String>;
